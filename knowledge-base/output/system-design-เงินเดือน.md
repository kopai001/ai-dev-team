...
class PayrollProcessingService {
  ...
  // Step 4: Preview summary ก่อน lock
  async getSummary(periodId: string): Promise<PayrollSummaryDto>
  // return: { totalBasePay, totalOT, totalGross, totalSS, totalTax, totalNet,
  //           employeeCount, byDepartment[] }
...
GET    /payroll/periods/:id/summary           ดูสรุปก่อน lock       [Payroll]
```
